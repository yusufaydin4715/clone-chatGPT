...
let userText = null;
const API_KEY = "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"; // saklanılacak
...
const loadDataFromLocalstorage = () => {
  ...
  themeButton.innerText = document.body.classList.contains("light-mode")
    ? "dark_mode"
    : "light_mode";
    //sohbet içerigini yerel depodan alir veya varsayilan içeriği uygular
  const defaultText = `<div class="default-text">
    <h1>ChatGPT Clone</h1>
    <p></p>
    </div>`;
  chatContainer.innerHTML = localStorage.getItem("all-chats") || defaultText;
  //sayfayi sohbetin en altına kaydirir
